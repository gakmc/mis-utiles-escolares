                    ...
                    <div class="w-full bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                        <div class="sm:hidden">
                            ...
                            <select id="tabs" class="bg-gray-50 border-0 border-b border-gray-200 text-gray-900 text-sm rounded-t-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" onchange="showTabContent(this.value)">
                                ...
                                <option value="tipos">Tipo de Productos</option>
                            </select>
                        </div>
                        <ul class="hidden text-sm font-medium text-center text-gray-500 divide-x divide-gray-200 rounded-lg sm:flex dark:divide-gray-600 dark:text-gray-400 rtl:divide-x-reverse" id="fullWidthTab" role="tablist">
                            ...
                            <li class="w-full">
                                <button onclick="showTabContent('tipos')" id="tipos-tab" type="button" role="tab" aria-controls="tipos" class="inline-block w-full p-4 rounded-se-lg bg-gray-50 hover:bg-gray-100 focus:outline-none dark:bg-gray-700 dark:hover:bg-gray-600">Tipo de Productos</button>
                            </li>
                        </ul>
                        <div id="fullWidthTabContent" class="border-t border-gray-200 dark:border-gray-600">
                            ...
                            <div class="hidden p-4 bg-white rounded-lg md:p-8 dark:bg-gray-800" id="tipos" role="tabpanel" aria-labelledby="tipos-tab">
                                <div class="flex justify-between items-center">
                                    <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Ingrese la informacion del tipo producto</h3>
                                </div>


                                <form class="max-w-xxl mx-auto" method="POST" action="{{ route('admin.tipo_producto.store')}}" >
                                    @csrf
        
        
                                    <div class="grid md:grid-cols-1 md:gap-4 mb-4 mt-4 ml-10">
                                        ...
                                        <div class="relative z-0 w-full mb-5 group">
                                            <input type="text" name="nombre_tipo_producto" id="nombre_tipo_producto"
                                                ...
                                                placeholder=" " value="{{ old('nombre_tipo_producto') }}" autofocus/>
                                            <label for="nombre_tipo_producto"
