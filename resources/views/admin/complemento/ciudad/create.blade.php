                        ...
                        <div id="fullWidthTabContent" class="border-t border-gray-200 dark:border-gray-600">
                            ...
                            <div class="hidden p-4 bg-white rounded-lg md:p-8 dark:bg-gray-800" id="ciudades" role="tabpanel" aria-labelledby="ciudades-tab">
                                <div class="flex justify-between items-center">
                                    <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Ingrese la ciudad</h3>
                                </div>


                                <form class="max-w-xxl mx-auto" method="POST" action="{{ route('admin.ciudad.store')}}" >
                                    @csrf
                                    ...
                                    <div class="grid md:grid-cols-1 md:gap-4 mb-4 mt-4 ml-10">
                                        ...
                                        <div class="relative z-0 w-full mb-5 group">
                                            <input type="text" name="nombre_ciudad" id="nombre_ciudad"
                                                ...
                                                placeholder=" " required value="{{ old('nombre_ciudad') }}" autofocus/>
