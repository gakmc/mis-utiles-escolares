            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <div>
                        ...
                        <form class="max-w-xxl mx-auto" method="POST" action="{{ route('admin.producto.store')}}" enctype="multipart/form-data" >
                            @csrf


                            <div class="grid md:grid-cols-3 md:gap-4 mb-4">

                                <div class="relative z-0 w-full mb-5 group">
                                    <input type="text" name="nombre_producto" id="nombre_producto"
                                        class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                                        placeholder=" " required value="{{ old('nombre_producto') }}"/>
                                ...
                                <div class="relative z-0 w-full mb-5 group">
                                    <input type="number" name="codigo_barra" id="codigo_barra"
                                        class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                                        placeholder=" " required  value="{{ old('codigo_barra') }}"/>
                                ...
                                <div class="relative z-0 w-full mb-5 group">
                                    <input type="number" name="lote_id" id="lote_id"
                                        class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                                        placeholder=" " required  value="{{ old('lote_id') }}"/>
                                    <label for="lote_id"
                            ...
                            <div class="grid md:grid-cols-3 md:gap-4">
                                ...
                                <div class="relative z-0 w-full mb-5 group">
                                    <select id="tipo_producto_id" name="tipo_producto_id"
                                        ...
                                        <option value="{{$tipo->id_tipo_producto}}" {{old('tipo_producto_id') === $tipo->nombre_tipo_producto ? 'selected' : ''}}>{{$tipo->nombre_tipo_producto}}</option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="relative z-0 w-full mb-5 group">
                                    ...
                                    id="imagen_producto" name="imagen_producto" type="file"  value="{{ old('imagen_producto') }}">
                            ...
                            <div class="grid md:grid-cols-3 md:gap-4">
                                ...
                                <div class="relative z-0 w-full mb-5 group">
                                    ...
                                    <input
                                    class="block w-full text-lg text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400"
                                    id="codigo_qr" name="codigo_qr" type="file"  value="{{ old('codigo_qr') }}">
                                    <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white"
                                        for="codigo_qr">Codigo QR</label>
                                    @error('codigo_qr')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
                                </div>
